          ...
          <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 mt-8 px-8">
                ...
                <div className="">
                  ...
                  <input type="text" placeholder="Enter Address" className="text-sm indent-4 py-2 bg-[#F9F9F9] text-[#737373] w-full border-1 rounded-sm border-[#E6E6E6] hover:border-[#F4511E] focus:border-[#F4511E] required"
                    />
                </div>
                <div className="">
                  <label  className="text-sm font-semibold leading-8">Unit Number<span className='text-[#F4551E] m-2'>*</span></label><br />
                  <input type="text" placeholder="Enter Unit" className="text-sm indent-4 py-2 bg-[#F9F9F9] text-[#737373] w-full border-1 rounded-sm border-[#E6E6E6] hover:border-[#F4511E] focus:border-[#F4511E] required"
                    />
                </div>
                <div className="">
                  <label  className="text-sm font-semibold leading-8">City<span className='text-[#F4551E] m-2'>*</span></label><br />
                  <select name="city" id="city" className="text-sm indent-4 py-2 bg-[#F9F9F9] text-[#737373] w-full border-1 rounded-sm border-[#E6E6E6] hover:border-[#F4511E] focus:border-[#F4511E] required">
                ...
                <div className="">
                  ...
                  <select name="State" id="State" className="text-sm indent-4 py-2 bg-[#F9F9F9] text-[#737373] w-full border-1 rounded-sm border-[#E6E6E6] hover:border-[#F4511E] focus:border-[#F4511E] required">
                ...
                <div className="">
                  ...
                  <select name="room" id="room" className="text-sm indent-4 py-2 bg-[#F9F9F9] text-[#737373] w-full border-1 rounded-sm border-[#E6E6E6] hover:border-[#F4511E] focus:border-[#F4511E] required">
                ...
                <div className="">
                  ...
                  <input type="text" placeholder="Enter Price" className="text-sm indent-4 py-2 bg-[#F9F9F9] text-[#737373] w-full border-1 rounded-sm border-[#E6E6E6] hover:border-[#F4511E] focus:border-[#F4511E] required"
                    />
                </div>
                <div className="">
                  <label  className="text-sm font-semibold leading-8">Room Type<span className='text-[#F4551E] m-2'>*</span></label><br />
              ...
              <div className="m-8">
                ...
                <textarea cols="30" rows="10" placeholder="Enter Description" className="text-sm indent-4 p-4 bg-[#F9F9F9] text-[#737373] w-full border-1 rounded-sm border-[#E6E6E6] hover:border-[#F4511E] focus:border-[#F4511E] required"
                  />
              </div>
                  ...
                  <input ref={inputRef} type="file" id="input-file-upload" multiple={true} onChange={handleChange} className="invisible" />
                      <label id="label-file-upload" htmlFor="input-file-upload" className={dragActive ? "drag-active" : "" }>
                        <div className="flex text-xs md:text-md p-1 gap-2 justify-center">
                          ...
                          <button className="upload-button text-[#F4551E] mt-0 md:mt-0 md:ml-0 hover:underline" onClick={onButtonClick}> browse</button>
                        </div>
                      </label>
